  ...
  <header class="w-full px-6 lg:px-36 py-6 flex flex-row justify-between border-b border-gray-100 shadow-sm dark:border-none dark:bg-[#161B22] dark:text-gray-400">
    ...
    <form class="max-w-md mx-auto" @submit.prevent="submit">
      ...
      <div class="relative">
          ...
          <input type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500" placeholder="Pesquisar..." required />
          <button type="submit" class="text-white absolute end-2.5 bottom-2.5 bg-emerald-700 hover:bg-emerald-800 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800">Buscar</button>
      </div>
    </form>
